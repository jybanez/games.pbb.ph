...
<body class="pbb-game-page" data-game="first-aid">
    ...
    <main class="pbb-game-shell">
        <section class="pbb-game-board">
            <p id="gameStatus" class="ui-badge">Match each situation with an action</p>
            <div class="pbb-match-grid">
                <div id="matchLeft" class="pbb-choice-grid"></div>
                <div id="matchRight" class="pbb-choice-grid"></div>
            </div>
        </section>
    </main>
